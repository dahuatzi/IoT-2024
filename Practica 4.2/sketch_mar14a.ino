...
* Define Constants
**************/
#define WIFISSID "TP-Link_5E05-blanco" //WIFI SSID aqui
#define PASSWORD "5BADF2C79D" // WIFI pwd
#define TOKEN "BBUS-HEXC2IsLIU0uFiHTQF7CuDdBij6Jkf" // Ubidots TOKEN ID el mismo que usamos en clase lo sacan de Ubidtos
#define MQTT_CLIENT_NAME "65ea5e1bc400c2000b6332ff" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices
#define VARIABLE_LABEL_temp "temperatura" // Variable Temperatura
#define VARIABLE_LABEL_hum "humedad" // Variable Humedad
#define DEVICE_LABEL "MiPrimerDevice-MQTT" // Nombre del dispositivo a crear
