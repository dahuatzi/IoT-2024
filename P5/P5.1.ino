...
const char* ssid = "TP-Link_5E05-blanco";
// your network password
const char* pass = "5BADF2C79D";
WiFiClient client;
unsigned long myChannelNumber = 2483972; //SECRET_CH_ID;
const char* myWriteAPIKey = "VT0DMFGA6YV51DFH";
