...
// wifi credentials
const char *ssid = "TP-Link_5E05-blanco"; // Tu SSID
const char *password = "5BADF2C79D"; // Tu PWD del SSID
WiFiClient client;
// OpenWeather
String apiTemperature;
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=20.6069&lon=103.415629&appid=39ec62536ad6649d3f55f2daff3c7b19&units=metric"; //El path que usaste en el web para la tem de la API - TODO el path con http
// ThingSpeak
uint32_t channelNumber = 2483972; // Tu channel ID number de thingspeak
const char *writeAPIKey = "VT0DMFGA6YV51DFH"; // El API write de thingspeak
void setup()
{
 Serial.begin(115200);
 dht.begin();
